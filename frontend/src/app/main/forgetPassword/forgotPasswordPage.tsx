...
import FormikHook, {createFormikObjects, typeOnlyNumber} from "../../../reusable/Form/FormikHook";

const steps = ["دریافت کد", "احراز هویت", "ثبت رمز عبور جدید"];
      ...
      <Paper className="w-full sm:w-auto min-h-full sm:min-h-auto rounded-0 py-32 px-8 sm:p-48 sm:rounded-2xl sm:shadow">
        <div className="w-full max-w-320 sm:w-320 mx-auto sm:mx-0">
          ...
          <div className="flex items-baseline my-12 font-medium">
            <Typography>رمزتان را به خاطر دارید؟</Typography>
